...
use the config file from <a href={useBaseUrl("deployment/config.agora.yml")} target="_blank">
deployment/config.agora.yml</a> as a base, copying it
instead.
...
For Troubleshooting please read the [deployment_troubleshooting.md](Deployment Troubleshooting).
